 ...
 */
std::string * Red::EncryptAesECB256(const std::string& in, const std::string_view key) {
 ...
 */
std::string * Red::DecryptAesECB256(const std::string& in, const std::string_view key) {

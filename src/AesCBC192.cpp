...
inline static void AES_init_ctx_iv(struct AES_ctx_CBC_192 *ctx, const uint8_t *key, const uint8_t *iv) {
...
// Encrypt operation.
inline static void AES_CBC_encrypt_buffer(struct AES_ctx_CBC_192 *ctx, uint8_t *buf, uint32_t length) {
    uintptr_t i;
    uint8_t *Iv = ctx->Iv;
...
// Decrypt operation.
inline static void AES_CBC_decrypt_buffer(struct AES_ctx_CBC_192 *ctx, uint8_t *buf,  uint32_t length) {
    uintptr_t i;
 ...
 */
const std::string Red::EncryptAesCBC192(const std::string& in, const std::string_view key,
 ...
 */
const std::string Red::DecryptAesCBC192(const std::string& in, const std::string_view key,
                                                      const std::string_view iv) {

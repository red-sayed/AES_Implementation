 ...
 */
std::string * Red::EncryptAesCBC192(const std::string& in, const std::string_view key,
 ...
 */
std::string * Red::DecryptAesCBC192(const std::string& in, const std::string_view key,
                                                           const std::string_view iv) {

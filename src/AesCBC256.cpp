...
inline static void AES_init_ctx_iv(struct AES_ctx_CBC_256 *ctx, const uint8_t *key, const uint8_t *iv) {
...
// Encrypt operation.
inline static void AES_CBC_encrypt_buffer(struct AES_ctx_CBC_256 *ctx, uint8_t *buf, uint32_t length) {
    uintptr_t i;
    uint8_t *Iv = ctx->Iv;
...
// Decrypt operation.
inline static void AES_CBC_decrypt_buffer(struct AES_ctx_CBC_256 *ctx, uint8_t *buf,  uint32_t length) {
    uintptr_t i;

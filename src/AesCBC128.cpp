 ...
 */
const std::string Red::EncryptAesCBC128(const std::string& in, const std::string_view key,
 ...
 */
const std::string Red::DecryptAesCBC128(const std::string& in, const std::string_view key,
                                                      const std::string_view iv) {

...
inline static void AES_init_ctx(struct AES_ctx_ECB_128 *ctx, const uint8_t *key) {
...
// Encrypt operation.
inline static void AES_ECB_encrypt(const struct AES_ctx_ECB_128 *ctx, uint8_t *buf) {
    Cipher((state_t *) buf, ctx->RoundKey);
}

// Decrypt operation.
inline static void AES_ECB_decrypt(const struct AES_ctx_ECB_128 *ctx, uint8_t *buf) {
    InvCipher((state_t *) buf, ctx->RoundKey);
}

/**
 * @brief Red::EncryptAesECB128
 *
 ...
 */
const std::string Red::EncryptAesECB128(const std::string& in, const std::string_view key) {
 ...
 */
const std::string Red::DecryptAesECB128(const std::string& in, const std::string_view key) {

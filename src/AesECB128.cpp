 ...
 */
std::string * Red::EncryptAesECB128(const std::string& in, const std::string_view key) {
 ...
 */
std::string * Red::DecryptAesECB128(const std::string& in, const std::string_view key) {
